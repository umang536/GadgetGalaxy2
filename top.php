                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.php"><img src="images/logo/gg_logo.png" alt="logo images" style="width: 30px; height: 30px;">GadgetGalaxy</a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-lg-4 col-sm-4 col-xs-4">
                                <div class="header__right">
                                    ...
                                    <div class="htc__shopping__cart">
                                        ...
                                        <a href="cart.php"><span class="htc__qua"><?php echo $total_products?></span></a>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
